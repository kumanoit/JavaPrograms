...
public class Constants {
	...
	public static final Integer preorder2[] = { 1, 2, 4, 8, 9, 5, 3, 6, 7 };
	public static final Integer postorder2[] = { 8, 9, 4, 5, 2, 6, 7, 3, 1 };
	public static final Integer inorder2[] = { 8, 4, 9, 2, 5, 1, 6, 3, 7 };
	public static final Integer levelorder2[] = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };

	public static final String string1[] = { "Hello", "Mr.", "Amit", "Kumar", "!!!" };
}
