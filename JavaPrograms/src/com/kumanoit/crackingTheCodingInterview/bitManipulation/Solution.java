...
public class Solution {
	 ...
	 * bit j and ends at bit i. You can assume that the bits j through i have
	 * enough space to fit all of M. That is, if M = 10011, you can assume that
	 * there are at least 5 bits between j and i. You would not, for example, have
	 * j = 3 and i = 2, because M could not fully fit between bit 3 and bit 2.
	 * EXAMPLE Input: N 10000000000, M Output: N = 10001001100 Hints: #137, #769,
	 * #215 10011, i 2, j 6
	 */

	/**
	 * 5.2 Binary to String: Given a real number between O and 1 (e.g., 0.72) that
	 ...
	 */
	/**
	 * Hints: #743, #767, #7 73, #269, #297 5.3 Flip Bit to Win: You have an
	 * integer and you can flip exactly one bit from a 0 to a 1. Write code to
	 * find the length of the longest sequence of ls you could create. EXAMPLE
	 * Input: 1775 Output: 8 (or: 11011101111) Hints: #759, #226, #374, #352
	 */
	/**
	 ...
	 * representation. Hints: #747, #7 75, #242, #372, #339, #358, #375, #390
	 */
	/**
	 *
	 ...
	 * need to flip to convert integer A to integer B. EXAMPLE Input: 29 (or:
	 * 11101), 15 (or: 01111) Output: 2 Hints: #336, #369 pg286
	 */
	/**
	 ...
	 * bit 2 and bit 3 are swapped, and so on). Hints: #745, #248, #328, #355 .
	 * ... .... . . . . pg 286
	 */
	/**
	 * 5.8 Draw Line: A monochrome screen is stored as a single array of bytes,
